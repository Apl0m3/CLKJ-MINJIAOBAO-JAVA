...
import com.lingkj.project.sys.dao.SysCaptchaDao;
import com.lingkj.project.sys.entity.SysCaptchaEntity;
...
public class SysCaptchaServiceImpl extends ServiceImpl<SysCaptchaDao, SysCaptchaEntity> implements SysCaptchaService {
    ...
    @Override
    public BufferedImage getCaptcha(String uuid, HttpServletRequest request) {
        if(StringUtils.isBlank(uuid)){
            throw new RRException(messageUtils.getMessage("manage.getCaptcha.error", request));
        }
        //生成文字验证码
