package com.lingkj.common.authentication.resolver;

import com.lingkj.project.user.entity.User;
import com.lingkj.project.user.service.AdminUserService;
import com.lingkj.common.authentication.annotation.LoginUser;
import com.lingkj.common.authentication.interceptor.*;
...
public class LoginUserHandlerMethodArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer container,
        ...
        //获取用户信息
        User user = adminUserService.getById((Long) object);
