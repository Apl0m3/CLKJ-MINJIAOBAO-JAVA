...
import com.lingkj.common.utils.payment.alipay.sign.MD5;
import com.lingkj.common.utils.payment.alipay.sign.RSA;
...
public class AlipayNotify {
	...
	public static boolean verifyReturn(Map<String, String> params, String key,
		...
		// 验证签名
		boolean isSign = getSignVeryfy(params, sign, true, key, sign_type);
	...
	public static boolean verifyNotify(Map<String, String> params,
                                       String partner, String key, String sign_type) throws Exception {
		...
		boolean isSign = getSignVeryfy(params, sign, false, key, sign_type);
	...
	private static boolean getSignVeryfy(Map<String, String> Params,
                                         String sign, boolean isSort, String key, String sign_type) {
	...
	public static boolean verify(Map<String, String> params, String partner,
								 String key, String aliPublicKey, String signType) {
		...
		boolean isSign = getSignVeryfy(params, sign, key, aliPublicKey,
				signType);
	 ...
	 */
	private static boolean getSignVeryfy(Map<String, String> Params,
                                         String sign, String key, String ali_public_key, String sign_type) {
		// 过滤空值、sign与sign_type参数
		Map<String, String> sParaNew = AlipayCore.paraFilter(Params);
		// 获取待签名字符串
		...
		if (sign_type.equals("0001")) {
			isSign = RSA.verify(preSignStr, sign, ali_public_key,
					AliPayConfig.CHARSET);
		}
		return isSign;
	}
